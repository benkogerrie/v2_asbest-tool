...
def test_description_field():
    """Test description field in prompt creation and updates"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Description: {prompt_data.get('description', 'NOT FOUND')}")
            
            if prompt_data.get('description') == "Dit is een test beschrijving":
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if updated_data.get('description') == "Bijgewerkte beschrijving":
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if test_prompt:
                ...
                if test_prompt.get('description') == "Bijgewerkte beschrijving":
                    print("✅ Description field persists correctly!")
                else:
                    print("❌ Description field not persisted")
            else:

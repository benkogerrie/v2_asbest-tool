...
# from app.api.routes import admin_prompts  # Temporarily disabled for deployment
...
# app.include_router(admin_prompts.router)  # Temporarily disabled for deployment
